...
local Locales = {
    ...
    ["enUS"] = {
        ...
        TUTORIAL_XP_BAR = "Paragon Experience|nProgress toward your next Paragon level. Hover the bar for exact numbers.|n|nEarned from kills, quests, achievements and skill-ups, plus one-off awards for filling out collections.",

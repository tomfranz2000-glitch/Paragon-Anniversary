...
class ParagonAchievementXPTests(unittest.TestCase):
    def setUp(self):
        ...
        self.lua.execute(
            ...
            AchievementPointXP = "10000"
            function Config:GetByField(field)
                if field == "PARAGON_ACHIEVEMENT_POINT_XP" then return AchievementPointXP end
                return nil
            end
    ...
    def test_world_dbc_hits_and_misses_are_cached(self):
        for achievement_id, expected in ((19001, 100000), (19999, 0), (19998, 0)):
